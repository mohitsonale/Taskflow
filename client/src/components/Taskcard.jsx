  ...
  return (
    ...
    <div className="bg-white rounded-3xl p-6 border border-slate-200 shadow-sm hover:shadow-md transition-all">
      ...
      <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4">
        ...
        <span
          className={`px-4 py-2 rounded-full text-sm font-medium w-fit ${getStatusStyle(task.status)}`}
        >
          {task.status}
        </span>
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mt-8">
        ...
        <div className="flex gap-3">
          ...
          <button
            ...
            className="border border-slate-300 hover:bg-slate-100 px-5 py-2 rounded-xl transition-all"
          >
            Edit
          </button>
